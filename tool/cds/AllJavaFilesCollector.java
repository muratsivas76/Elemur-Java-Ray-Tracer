...
public class AllJavaFilesCollector {
  public static void main(String[] args) {
    ...
    String outFile = "/home/muratsivas76/istasyon/java/extended_elemurrt_v4/tool/cds/files_all.txt";
    ...
    try (BufferedWriter writer = new BufferedWriter(new FileWriter(outFile))) {
      ...
      System.out.println("All Java files collected successfully to tool/cds/files_all.txt!");
      } catch (IOException e) {
