...
public class Utilities extends Object {
    ...
    public static final String[] MATERIAL_TYPES = {
        ...
        "LambertMaterial", "TransparentPNGMaterial", "WordMaterial", "IsotropicMetalTextMaterial",
        "AfricanKenteMaterial", "AmberMaterial", "AnisotropicMetalMaterial", "AnodizedMetalMaterial", "AnodizedTextMaterial", "AuroraCeramicMaterial",
        "BaklavaMaterial", "BlackHoleMaterial", "BrightnessMaterial", "BrunostCheeseMaterial",
        "CalligraphyRuneMaterial", "CarpetTextureMaterial", "CeramicTilePBRMaterial", "CiniMaterial", "CircleTextureMaterial", "ChromePBRMaterial", "CoffeeFjordMaterial", "ContrastMaterial", "CopperMaterial", "CopperPBRMaterial", "CrystalClearMaterial", "CrystalMaterial",
        "DamaskCeramicMaterial", "DewDropMaterial", "DiagonalCheckerMaterial", "DiamondMaterial", "DielectricMaterial", "DiffuseMaterial",
        "EdgeLightColorMaterial", "EmeraldMaterial",
        "FjordCrystalMaterial", "FractalBarkMaterial", "FractalFireMaterial",
        "GhostTextMaterial", "GlassicTilePBRMaterial", "GlassMaterial", "GoldMaterial", "GoldPBRMaterial", "GradientChessMaterial", "GradientImageTextMaterial", "GradientTextMaterial", "GraniteMaterial",
        "HamamSaunaMaterial", "HexagonalHoneycombMaterial", "HokusaiMaterial", "HologramDataMaterial", "HolographicDiffractionMaterial", "HolographicPBRMaterial", "HotCopperMaterial", "HybridTextMaterial",
        "InvertLightColorMaterial",
        "KilimRosemalingMaterial",
        "LavaFlowMaterial", "LightningMaterial", "LinearGradientMaterial",
        "MarbleMaterial", "MarblePBRMaterial", "MetallicMaterial", "MirrorMaterial", "MoonSurfaceMaterial", "MosaicMaterial", "MultiMixMaterial",
        "NazarMaterial", "NeutralMaterial", "NonScaledTransparentPNGMaterial", "NordicWeaveMaterial", "NordicWoodMaterial", "NorthernLightMaterial", "NorwegianRoseMaterial",
        "OpticalIllusionMaterial", "OrbitalMaterial",
        "PhongElenaMaterial", "PhongMaterial", "PixelArtMaterial", "PlasticPBRMaterial", "PlatinumMaterial", "PolkaDotMaterial", "ProceduralCloudMaterial", "ProceduralFlowerMaterial", "PureWaterMaterial",
        "QuantumFieldMaterial",
        "RadialGradientMaterial", "RandomMaterial", "ReflectiveMaterial", "RosemalingMaterial", "RubyMaterial", "RuneStoneMaterial",
        "SalmonMaterial", "SandMaterial", "SilverMaterial", "SilverPBRMaterial", "SimitMaterial", "SolidCheckerboardMaterial", "SolidColorMaterial", "SquaredMaterial", "StainedGlassMaterial", "StarfieldMaterial", "StarryNightMaterial", "StripedMaterial", "SultanKingMaterial",
        "TelemarkPatternMaterial", "TexturedCheckerboardMaterial", "TexturedPhongMaterial", "TransparentEmissivePNGMaterial", "TransparentEmojiMaterial", "TriangleMaterial", "TulipFjordMaterial", "TurkishTileMaterial", "TurkishDelightMaterial",
        "VikingMetalMaterial", "VikingRuneMaterial",
        "WaterfallMaterial", "WaterPBRMaterial", "WoodMaterial", "WoodPBRMaterial", "WoodGrainMaterial",
        "XRayMaterial",
        "CustomMaterial"
    };
    ...
    public static final String VAL_SHAPE_STR = "<html><body><font color=\"#00DD00\" size=\"5\"><b>Enter anim incdec transform vals in this format: [tx ty tz]*[rx ry rz]*[sx sy sz]:[tx ty tz]*[rx ry rz]*[sx sy sz]</b></font></body></html>";
    public static final String VAL_SHAPE_STR_TR = "<html><body><font color=\"#00DD00\" size=\"5\"><b>Enter transform vals in this format: [tx ty tz]*[rx ry rz]*[sx sy sz]</b></font></body></html>";
    public static final String USER_INPUT = "User input";
    public static final String DEFFADES = "0000ff:0.03:0.04";
    public static final String FADEVALS = "<html><body><font size=\"5\">baseColor:fade:temp (Ex, 0000ff:0.03:0.04</font></body></html>";
    public static final String ENTERCOLOR = "<html><body><font color=\"#0000DD\" size=\"5\">Enter Color: HexARGB or Float|IntRGBAcomma</font></body></html>";
    //public static final String SHADOWPRESTR = "#FF000000";
    public static final String ENTERBIAS = "<html><body><font color=\"#0000DD\" size=\"5\">Enter Shadow BIAS double:</font></body></html>";
    //public static final String BIASPRESTR = "0.001";
	public static final String ENTERVISIBILITY = "<html><body><font color=\"#0000DD\" size=\"5\">Enter Visibility0/VisibilitySpecial1(0|1:e/y/v/t visible,<br/>otherwise invisible:</font></body></html>";
    //public static final String VISIBLEPRESTR = "0|1:n";
    public static final String ENTERINTENSITY = "<html><body><font color=\"red\" size=\"5\">Enter new intensity double value:</font></body></html>";
    public static final String INTPREVAL = "1.0";
    public static final String ENTERSHADOWONLY = "<html><body><font color=\"#0000DD\" size=\"5\">Enter ShadowOnly(e/y/v/t onlyShadow, otherwise notOnlyShadow:</font></body></html>";
    //public static final String SHADONPRESTR = "y";
    public static final String ENTERSHADOWENABLE = "<html><body><font color=\"#0000DD\" size=\"5\">Enter ShadowEnable(e/y/v/t enabled, otherwise notEnabled:</font></body></html>";
    //public static final String SHADENPRESTR = "n";
    public static final String ENTERREFR = "<html><body><font color=\"#0000DD\" size=\"5\">Enter Reflectivity0/Refractivity1(e/y/v/t yes, otherwise not:<p>Example: 0:e<p>Example: 1:n</font></body></html>";
    //public static final String RFPRESTR = "0:n";
    public static final String ENTEROTHERANIMS = "<html><body><font color=\"red\" size=\"5\">Enter info of each frame. <p>v=visibile<p>e=shadowEnable<p>o=shadowOnly<p>f=reflective<p>r=refractive<p><p>Example: veofr,00000,veofr</font></body></html>";
    //public static final String OAPRE = "veofr,00000,ve0fr";
    ...
    public static String getLightTemplate(String type) {
        switch (type) {
            case "ElenaMuratAmbientLight": return "name = ambient;\ncolor = #191919;\nintensity = 0.25;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;";
            case "MuratPointLight": return "name = point;\nposition = P(2.000, 5.000, 2.000);\ncolor = #FFFFFF;\nintensity = 1.0;\nconstantAttenuation = 1.0;\nlinearAttenuation = 0.1;\nquadraticAttenuation = 0.01;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;";
            case "ElenaDirectionalLight": return "name = directional;\ndirection = V(-1.000,-1.000,-1.000);\ncolor = #E8E8E8;\nintensity = 0.9;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;";
            case "SpotLight": return "name = spot;\nposition = P(5,5,5);\ndirection = V(-1,-1,-1);\ncolor = #FFFF00;\nintensity = 1.0;\ninnerConeAngle = 10.0;\nouterConeAngle = 20.0;\nconstantAttenuation = 1.0;\nlinearAttenuation = 0.09;\nquadraticAttenuation = 0.032;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;" + WARNLIGHT;
            case "SphereLight": return "name = sphering;\nposition = P(0.000, 2.000, 0.000);\ncolor = #FFFFF2E6;\nintensity = 1.0;\nradius = 0.3;\nsampleCount = 12;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;";
            case "TubeLight": return "name = tube;\nposition = P(0.000, 3.000, 0.000);\ncolor = #FFFFFF;\nintensity = 0.8;\nstartPoint = P(-1.000, 3.000, 0.000);\nendPoint = P(1.000, 3.000, 0.000);\nradius = 0.1;\nlength = 2.0;\nsampleCount = 8;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;";
            case "AreaLight": return "name = area;\nposition = P(0.000, 4.000, 0.000);\ncolor = #FFFFFF;\nintensity = 0.9;\nnormal = V(0.000, -1.000, 0.000);\nwidth = 3.0;\nheight = 2.0;\nsamplesU = 6;\nsamplesV = 4;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;";
            case "BioluminescentLight": return "name = bioluminescent;\npositions = [P(0,1,0)];\ncolor = #00FF00;\npulseSpeed = 0.5;\nbaseIntensity = 1.0;\nattenuationFactor = 0.1;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;" + WARNLIGHT;
            case "BlackHoleLight": return "name = blackhole;\nsingularity = P(0,0,0);\nradius = 1.0;\ncolor = #000000;\nintensity = 1.0;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;" + WARNLIGHT;
            case "PulsatingPointLight": return "name = pulsating;\ninitialPosition = P(5,5,5);\nbaseColor = #FF0000;\nbaseIntensity = 1.0;\npulsationSpeed = 0.5;\nmovementSpeed = 0.1;\nmovementAmplitude = 1.0;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;" + WARNLIGHT;
            case "FractalLight": return "name = fractal;\nposition = P(5,5,5);\ncolor = #FF00FF;\nintensity = 1.0;\noctaves = 4;\npersistence = 0.5;\nfrequency = 2.0;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;" + WARNLIGHT;
            case "CustomLight": return "name = custom;\nclassName = extraSML/TestLight.class;\nfirstAnimationIntensity = 0.0;\nsecondAnimationIntensity = 0.0;" + WARNLIGHT;
            default: return "";
        }
    }
    ...
    public static String getShapeTemplate(String type) {
        switch (type) {
            case "Box": return "name = box;\nwidth = 2.0;\nheight = 2.0;\ndepth = 2.0;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Cone": return "name = cone;\nradius = 1.0;\nheight = 2.0;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Crescent": return "name = crescent;\nradius = 1.0;\ncutRadius = 0.5;\ncutDistance = 0.2;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Cube": return "name = cube;\nsideLength = 2.0;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Cylinder": return "name = cylinder;\nradius = 1.0;\nheight = 2.0;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Ellipsoid": return "name = ellipsoid;\ncenter = P(0,0,0);\na = 1.0;\nb = 0.8;\nc = 0.6;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "EmojiBillboard": return "name = emojibillboard;\nwidth = 20.0;\nheight = 10.0;\nisRectangle = false;\nimagePath = \"textures/turkeyFlag.png\";\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = false;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Hyperboloid": return "name = hyperboloid;\na = 1.0;\nb = 1.0;\nc = 1.0;\nheight = 2.0;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Plane": return "name = plane;\npointOnPlane = P(0,0,0);\nnormal = V(0,1,0);\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = v00fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = false;\nisReflective = true;\nisRefractive = true;";
            case "TransparentPlane": return "name = transparentplane;\npointOnPlane = P(0,0,0);\nnormal = V(0,0,1);\nthickness = 0.1;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Rectangle3D": return "name = rectangle3d;\np1 = P(-1,-1,0);\np2 = P(1,1,0);\nthickness = 0.1;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "RectangularPrism": return "name = rectangularprism;\nwidth = 2.0;\nheight = 1.0;\ndepth = 0.5;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Sphere": return "name = sphere;\nradius = 1.5;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Torus": return "name = torus;\nmajorRadius = 2.0;\nminorRadius = 0.5;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "TorusKnot": return "name = torusknot;\nR = 2.0;\nr = 0.5;\np = 2;\nq = 3;\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "Triangle": return "name = triangle;\nv0 = P(-1,0,0);\nv1 = P(1,0,0);\nv2 = P(0,1,0);\nshadowColor = #FF000000;\nshadowBias = 0.001;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;";
            case "UnionCSG": return "name = unioncsg;\nshadowColor = #FF000000;\nshadowBias = 0.001;\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\n ";
            case "IntersectionCSG": return "name = intersectioncsg;\nshadowColor = #FF000000;\nshadowBias = 0.001;\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\n ";
            case "DifferenceCSG": return "name = differencecsg;\nshadowColor = #FF000000;\nshadowBias = 0.001;\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\n ";
            case "CustomShape": return "name = customshape;\nclassName = extraSML/TestShape.class;\nshadowColor = #FF000000;\nshadowBias = 0.001;\notherAnimationInfo = ve0fr,0e0fr,veofr,ve0fr;\nisVisibleSpecial = true;\nisVisible = true;\nisShadowOnly = false;\nisShadowEnable = true;\nisReflective = true;\nisRefractive = true;\nfirstAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);\nsecondAnim_transform = translate(0, 0, 0) * rotate(0, 0, 0) * scale(1, 1, 1);";
            default: return "";
        }
    }
    ...
    public static String getMaterialTemplate(String type) {
        switch (type) {
            ...
            case "WordMaterial": return "text = \"Merhaba Sevgili Dostlar!\";\nforegroundColor = #FF0000;\nbackgroundColor = #00000000;\nfontName = \"Arial\";\nfontSize = 50;\nfontStyle = 1;\nuseGradient = true;\ngradientColor = #00DD00;\nwidth = 1000;\nheight = 80;\nuOffset = 0.0;\nvOffset = 0.0;\nbillboardWidth = 8.5;\nbillboardHeight = 1.5;";
        ...
        try {
            switch (type) {
                case "BioluminescentLight": {
                    ...
                    String name = parseString(text, "name");
                    lg.setName(name);
                    return lg;
                } case "BlackHoleLight": {
        ...
        try {
            switch (type) {
                case "Box": {
                    ...
                    Color shdwColor = parseColor(text, "shadowColor");
                    double shdwBias = parseDouble(text, "shadowBias");
                    shp.setShadowColor(shdwColor);
                    shp.setShadowBias(shdwBias);
                    String otherAnimationInfo = parseString(text, "otherAnimationInfo");
                    boolean isVisible = parseBoolean(text, "isVisible");
                    boolean isShadowEnable = parseBoolean(text, "isShadowEnable");
                    boolean isShadowOnly = parseBoolean(text, "isShadowOnly");
                    boolean isReflective = parseBoolean(text, "isReflective");
                    boolean isRefractive = parseBoolean(text, "isRefractive");
                    shp.setOtherAnimationInfo(otherAnimationInfo);
                    shp.setVisible(isVisible);
                    shp.setShadowEnable(isShadowEnable);
                    shp.setShadowOnly(isShadowOnly);
                    shp.setReflective(isReflective);
                    shp.setRefractive(isRefractive);
                    boolean isVisibleSpecial = parseBoolean(text, "isVisibleSpecial");
                    shp.setVisibleSpecial(isVisibleSpecial);
                    String name = parseString(text, "name");
                    shp.setName(name);
                    return shp;
                } case "Cone": {
                    ...
                    EMShape shp = new EmojiBillboard(width, height, isRect, isVisible, img);
                    ((EmojiBillboard)shp).setImagePath(path);
                    Matrix4 xanimTransform = parseAnimationTransform(text, "firstAnim_transform");
                    Matrix4 yanimTransform = parseAnimationTransform(text, "secondAnim_transform");
                    shp.setAnimationTransforms(new Matrix4[]{xanimTransform, yanimTransform});
                    Color shdwColor = parseColor(text, "shadowColor");
        ...
        try {
            switch (type) {
                ...
                case "WoodMaterial": {
                    ...
                    double uOffset = parseDouble(text, "uOffset");
                    double vOffset = parseDouble(text, "vOffset");
                    double billboardWidth = parseDouble(text, "billboardWidth");
                    double billboardHeight = parseDouble(text, "billboardHeight");

                    Font font = new Font(fontName, fontStyle, fontSize);

                    // Yeni full constructor ile UV offset desteği
                    WordMaterial mw = new WordMaterial(textStr, fg, bg, font, useGradient, gradientColor, null, width, height, uOffset, vOffset);
                    mw.setBillboardWidth(billboardWidth);
                    mw.setBillboardHeight(billboardHeight);
                    return mw;
                } case "XRayMaterial": {
                    Color base = parseColor(text, "baseColor");
                    double trans = parseDouble(text, "transparency");
    ...
    */
    ...
    public static boolean parseBoolean(String block) {
		String val = block.replace("\"", "").replace("'", "");
		return Boolean.parseBoolean(val);
    }
    ...
    public static Color parseFlexibleColor(String colorStr) {
        ...
        try {
            ...
            if ((colorStr.contains(",") == false) &&
            (colorStr.contains(" ") == false) &&
            (colorStr.length() <= 8)) {
                return parseHexColor(colorStr);
            }
    ...
    public static EMShape parseCSGShape(String text) {
        try {
            ...
            Color shdw = parseFlexibleColor(blocks.shadowColorBlock);
            double bias = parseDouble(blocks.shadowBiasBlock);
            String otherAnimationInfo = blocks.otherAnimationInfoBlock;
            boolean isVisible = parseBoolean(blocks.isVisibleBlock); 
			boolean isShadowEnable = parseBoolean(blocks.isShadowEnableBlock);
			boolean isShadowOnly = parseBoolean(blocks.isShadowOnlyBlock);
			boolean isReflective = parseBoolean(blocks.isReflectiveBlock);
			boolean isRefractive = parseBoolean(blocks.isRefractiveBlock);
            ...
            csgShape.setShadowColor(shdw);
            csgShape.setShadowBias(bias);
			csgShape.setOtherAnimationInfo(otherAnimationInfo);
			csgShape.setVisible(isVisible);
			csgShape.setShadowEnable(isShadowEnable);
			csgShape.setShadowOnly(isShadowOnly);
			csgShape.setReflective(isReflective);
			csgShape.setRefractive(isRefractive);
    ...
    private static class CSGBlocks {
        ...
        String shadowColorBlock;
        String shadowBiasBlock;
        String otherAnimationInfoBlock;
        String isVisibleBlock;
        String isShadowOnlyBlock;
        String isShadowEnableBlock;
        String isReflectiveBlock;
        String isRefractiveBlock;
    }
    ...
    private static CSGBlocks extractCSGBlocks(String content) {
        ...
        try {
            ...
            // Remaining parts (transform and material
            ...
            blocks.shadowColorBlock = extractLineAfter(remaining, "shadowColor = ");
            blocks.shadowBiasBlock = extractLineAfter(remaining, "shadowBias = ");
            
			blocks.otherAnimationInfoBlock = extractLineAfter(remaining, "otherAnimationInfo = ");			
		    
		    blocks.isVisibleBlock = extractLineAfter(remaining, "isVisible = ");
			blocks.isShadowEnableBlock = extractLineAfter(remaining, "isShadowEnable = ");
			blocks.isShadowOnlyBlock = extractLineAfter(remaining, "isShadowOnly = ");
			blocks.isReflectiveBlock = extractLineAfter(remaining, "isReflective = ");
			blocks.isRefractiveBlock = extractLineAfter(remaining, "isRefractive = ");
    ...
    private static EMShape parseCSGSubShape(String block) {
        ...
        if (shape != null) {
            ...
            //Color shdw = parseColor(block, "shadowColor");
            //double bias = parseDouble(block, "shadowBias");

            shape.setTransform(transform);
            //shape.setAnimationTransforms(new Matrix4[]{a1Transform, a2Transform});
            //shape.setShadowColor(shdw);
    ...
    public static Point3 pixelToWorld(int pixelX, int pixelY, int screenWidth, int screenHeight, Camera camera) {
        // Camera vectors
        Vector3 gaze = camera.getLookAt().minus(camera.getCameraPosition()).toVector().normalize();
        Vector3 u = camera.getUpVector().cross(gaze).normalize();
        Vector3 v = gaze.cross(u).normalize();

        // View plane parameters
        double aspectRatio = (double) screenWidth / screenHeight;
        double distance;

        // Perspektif projektion
        if (camera.getFov() <= 0) {
            distance = 1.0;
        } else {
            distance = 1.0 / Math.tan(Math.toRadians(camera.getFov()) / 2.0);
        }

        // Pixel coordinates [-1, 1] normalize
        //double ndcX = (2.0 * pixelX / (screenWidth - 1)) - 1.0;
        double ndcX = 1.0 - (2.0 * pixelX / (screenWidth - 1)); // X reves
        double ndcY = 1.0 - (2.0 * pixelY / (screenHeight - 1));

        // Aspect ratio
        ndcX *= aspectRatio;

        Point3 cameraPosition = camera.getCameraPosition();

        // Point3.add()
        Point3 imagePoint = cameraPosition.add(u.times(ndcX))
        .add(v.times(ndcY))
        .add(gaze.times(distance));

        // Point3 to Vector3 and normalize
        Vector3 rayDirection = imagePoint.minus(cameraPosition).toVector().normalize();

        if (Math.abs(rayDirection.z) > 1e-6) {
            double t = -cameraPosition.z / rayDirection.z;
            return new Point3(
            cameraPosition.x + rayDirection.x * t,
