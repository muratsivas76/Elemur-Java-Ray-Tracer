...
public class Ray {
  ...
  public static final double BIAS = 1e-3;
  
  // Minimum intersection distance for shadow rays
  // Reduced to better handle reflective materials while maintaining 
  // self-intersection prevention for diffuse materials
  public static final double MIN_SHADOW_DISTANCE = 0.08;
